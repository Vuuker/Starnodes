...
In order to support loading of multiple wallets in starnodes-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is starnodes.cpp.
...
Changes to starnodes.cpp
----------------------
starnodes.cpp is the entry point into starnodes-qt, and as such, will require some minor modifications to provide hooks for
