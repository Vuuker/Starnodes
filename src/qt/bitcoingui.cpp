                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Starnodes Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Starnodes address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and starnodes: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Starnodes Core"), this);
    aboutAction->setStatusTip(tr("Show information about Starnodes Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Starnodes"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Starnodes addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Starnodes addresses"));
    ...
    openAction->setStatusTip(tr("Open a Starnodes: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Starnodes Core help message to get a list with possible Starnodes command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Starnodes Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Starnodes network", "", count));
}
...
{
    QString strTitle = tr("Starnodes Core"); // default title
