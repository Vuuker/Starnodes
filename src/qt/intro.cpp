...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Starnodes Core"),
     ...
     * override -datadir in the starnodes.conf file in the default data directory
     * (to be consistent with starnodesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
