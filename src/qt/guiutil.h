...
/** Utility functions used by the Starnodes Qt UI.
 */
namespace GUIUtil
{
...
// Render Starnodes addresses in monospace font
...
// Parse "starnodes:" URI into recipient object, return true on successful parsing
