...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Starnodes server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Starnodes server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Starnodes features */
        {"starnodes", "masternode", &masternode, true, true, false},
        {"starnodes", "listmasternodes", &listmasternodes, true, true, false},
        {"starnodes", "getmasternodecount", &getmasternodecount, true, true, false},
        {"starnodes", "masternodeconnect", &masternodeconnect, true, true, false},
        {"starnodes", "masternodecurrent", &masternodecurrent, true, true, false},
        {"starnodes", "masternodedebug", &masternodedebug, true, true, false},
        {"starnodes", "startmasternode", &startmasternode, true, true, false},
        {"starnodes", "createmasternodekey", &createmasternodekey, true, true, false},
        {"starnodes", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"starnodes", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"starnodes", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"starnodes", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"starnodes", "getmasternodescores", &getmasternodescores, true, true, false},
        {"starnodes", "mnbudget", &mnbudget, true, true, false},
        {"starnodes", "preparebudget", &preparebudget, true, true, false},
        {"starnodes", "submitbudget", &submitbudget, true, true, false},
        {"starnodes", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"starnodes", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"starnodes", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"starnodes", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"starnodes", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"starnodes", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"starnodes", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"starnodes", "checkbudgets", &checkbudgets, true, true, false},
        {"starnodes", "mnsync", &mnsync, true, true, false},
        {"starnodes", "spork", &spork, true, true, false},
        {"starnodes", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"starnodes", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use starnodesd, or the -server option to starnodes-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> starnodes-cli " + methodname + " " + args + "\n";
}
