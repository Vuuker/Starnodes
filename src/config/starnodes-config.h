/* src/config/starnodes-config.h.  Generated from starnodes-config.h.in by configure.  */
/* src/config/starnodes-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.starnodes.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Starnodes Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Starnodes Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "starnodes"
