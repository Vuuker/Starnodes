...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Starnodes Core starnodes-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  starnodes-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded starnodes transaction") + "\n" +
                               "  starnodes-tx [options] -create [commands]   " + _("Create hex-encoded starnodes transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded starnodes transaction
