...
#if defined(NDEBUG)
#error "Starnodes cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 600 * COIN;
    }   else if (nHeight <= 35000 && nHeight > 30000) {
        nSubsidy = 700 * COIN;
    }   else if (nHeight <= 40000 && nHeight > 35000) {
        nSubsidy = 800 * COIN;
    }   else if (nHeight <= 45000 && nHeight > 40000) {
        nSubsidy = 900 * COIN;
    }   else if (nHeight <= 50000 && nHeight > 45000) {
        nSubsidy = 1000 * COIN;
    }   else if (nHeight <= 55000 && nHeight > 50000) {
        nSubsidy = 1100 * COIN;
    }   else if (nHeight <= 60000 && nHeight > 55000) {
        nSubsidy = 1200 * COIN;
        ...
        nSubsidy = 1700 * COIN;
    }   else if (nHeight <= 90000 && nHeight > 85000) {
        nSubsidy = 1800 * COIN;
    }   else if (nHeight <= 95000 && nHeight > 90000) {
        nSubsidy = 1900 * COIN;
    }   else if (nHeight <= 100000 && nHeight > 95000) {
        nSubsidy = 2000 * COIN;
        ...
        nSubsidy = 500 * COIN;
 }   else if (nHeight <= 4000000 && nHeight > 2500000) {
        nSubsidy = 250 * COIN;
 }   else if (nHeight <= 8000000 && nHeight > 4000000) {
        nSubsidy = 100 * COIN;
 }   else if (nHeight <= 10000000 && nHeight > 8000000) {
        nSubsidy = 10 * COIN;
    }   else {
        nSubsidy = 1 * COIN;
    }
...
{
    RenameThread("starnodes-scriptch");
