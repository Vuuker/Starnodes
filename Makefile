...
pkgdatadir = $(datadir)/starnodes
pkgincludedir = $(includedir)/starnodes
pkglibdir = $(libdir)/starnodes
pkglibexecdir = $(libexecdir)/starnodes
...
CONFIG_HEADER = $(top_builddir)/src/config/starnodes-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/starnodes-config.h.in \
...
ACLOCAL = ${SHELL} /home/edson/Starnodes/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/edson/Starnodes/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/edson/Starnodes/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/edson/Starnodes/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/edson/Starnodes/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = starnodes
PACKAGE_BUGREPORT = www.starnodes.org
PACKAGE_NAME = Starnodes Core
PACKAGE_STRING = Starnodes Core 1.0.0
PACKAGE_TARNAME = starnodes
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/edson/Starnodes
abs_srcdir = /home/edson/Starnodes
abs_top_builddir = /home/edson/Starnodes
abs_top_srcdir = /home/edson/Starnodes
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/edson/Starnodes/build-aux/install-sh
...
SUBDIRS = src
BITCOIND_BIN = $(top_builddir)/src/starnodesd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/starnodes-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/starnodes-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = Starnodes-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_starnodes_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_starnodes_coverage.info test_starnodes.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Starnodes-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/starnodes-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/starnodes-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/starnodes-config.h
$(top_srcdir)/src/config/starnodes-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/starnodes-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Starnodes-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Starnodes-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Starnodes-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_starnodes.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_starnodes -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_starnodes_filtered.info: test_starnodes.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_starnodes_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_starnodes_coverage.info: baseline_filtered_combined.info test_starnodes_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_starnodes_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_starnodes_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_starnodes_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_starnodes.coverage/.dirstamp:  test_starnodes_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_starnodes.coverage/.dirstamp total.coverage/.dirstamp

# Starnodes: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_starnodes.coverage/ total.coverage/ $(OSX_APP)
